...
- [2026-05-21] Добавлен рабочий ритуал «Переходим в новый чат»: команда должна фиксировать контекст, memory graph, саммари, делать commit + push и выдавать готовый prompt для продолжения.
- [2026-05-21] Добавлен `brain/workstations.md` — реестр MCP и локальных инструментов по рабочему ПК, домашнему ПК, homeserver и VPS.
- [2026-05-21] Зафиксировано разделение личностей: Codex — отдельный рабочий инженерный напарник в локальном чате; Коготь — отдельный OpenClaw-агент в Telegram. Не называть Когтя “формой Codex”.

## СЛЕДУЮЩИЙ ШАГ
Продолжить с улучшения UX слоя 1: более умная классификация “запомни” → note/task/decision, убрать тестовые записи из `assistant_*` при необходимости, после push перевести `/home/sergei/Claude_Home` на чистую git-синхронизацию. Держать разделение: Codex отдельно, Коготь отдельно.
