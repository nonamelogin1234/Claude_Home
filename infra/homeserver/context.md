...
- [2026-05-28] Настроена автоматизация рабочих звонков: Samsung пишет `.m4a` в Nextcloud `/Call`, n8n на VPS обрабатывает только свежие записи из whitelist контактов, делает расшифровку/подробный конспект через OpenAI и создаёт дочерние страницы в Notion `Конспекты звонков`.
