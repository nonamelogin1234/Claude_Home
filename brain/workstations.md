...
| ГЛАВНОЕ ПРАВИЛО: никогда не отключать/не трогать VPN как побочный шаг диагностики | ✅ зафиксировано в `brain/core-work.md` | ⬜ продублировать аналогичный блок в `brain/core-home.md` |
