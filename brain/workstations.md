...
| `spotify` | 🟡 Ожидает авторизации | `@0xbarandiaran/spotify-mcp-server` (глобально), конфиг `~/.spotify-mcp/config.json`. Пользователь должен кликнуть Agree в Vivaldi для OAuth. |
