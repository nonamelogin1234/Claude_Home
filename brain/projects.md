...
| 🔧 pyRevit-расширение ВК (вкладка «Избранное») | 🟢 Работает, развивается пользователем | Уточнить и реализовать блок «Системы → Сантехника и водопроводы»; протестировать «Скрыть системы» в реальном проекте | projects/pyrevit-vk/ |
