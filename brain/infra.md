...
| LDvZi8x7YlVRFMmi | Call Recordings → Notion summaries | Свежие записи звонков из Nextcloud `/Call` → OpenAI transcription/summary → Notion `Рабочие звонки`, каждые 3 мин |
