...
| mcp.myserver-ai.ru:7723 | shell-api :7722 HTTPS |
| mcp.myserver-ai.ru:7724 | home shell-api через wg1 |
| mcp.myserver-ai.ru:8767/mcp | kinoclaude :8766 HTTPS |
...
| hevy_sets | Детальные сеты Hevy (каждый подход) |
